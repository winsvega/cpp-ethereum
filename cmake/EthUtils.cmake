...
function(enable_bulkbuild BB_UNIT_NAME SOURCE_VARIABLE_NAME)
	if (BULK_BUILD)
		set(original_source_files ${${SOURCE_VARIABLE_NAME}})
		set(bulkbuild_filename ${CMAKE_CURRENT_BINARY_DIR}/BulkBuild_${BB_UNIT_NAME}.cpp)
		# Tag the original source files as "header only" within CMake.
		set_source_files_properties(${files} PROPERTIES HEADER_FILE_ONLY true)
		FILE(WRITE ${bulkbuild_filename} "// This is a generated file.\n")
		foreach(source_filename ${original_source_files})
			FILE(APPEND ${bulkbuild_filename} "#include <${CMAKE_CURRENT_SOURCE_DIR}/${source_filename}>\n")
